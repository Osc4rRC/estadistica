...
#tabla_mod_college <- subset(tabla_universidad, Freq>3)
#otra <- data.frame(
#  College=c("Otra"),
#  Freq=sum(tabla_universidad$Freq<=3)
#)
...
# Diagrama Circular
par(mfrow=c(1,2))
pie(tabla_posicion$Freq,labels=paste(c("C","PF","PG","SF","SG"),tabla_posicion$Freq,sep=": "),col=2:7,radius=1)
title("Diagrama de pastel - Posiciones \n (Frecuencias)")
pie(tabla_posicion$Rel,labels=paste(c("C","PF","PG","SF","SG"),tabla_posicion$Rel,sep=": "),col=2:7,radius=1)
title("Diagrama de pastel - Posiciones \n (Frecuencias relativas)")
```
```{r}

par(mfrow=c(1,2))
pie3D(tabla_posicion$Freq,labels=paste(c("C","PF","PG","SF","SG"),tabla_posicion$Freq,sep=": "),col=2:7,explode = 0.1)
title("Diagrama de pastel - Posiciones \n (Frecuencias)")
pie3D(tabla_posicion$Rel,labels=paste(c("C","PF","PG","SF","SG"),tabla_posicion$Rel,sep=": "),col=2:7,explode = 0.1)
title("Diagrama de pastel - Posiciones \n (Frecuencias relativas)")
